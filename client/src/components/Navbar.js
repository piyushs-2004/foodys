...
export default function Navbar() {
  ...
  <div className="container-fluid">
    <Link className="navbar-brand fs-1 fs-i" to="/">Foodys</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      ...
      <div className="d-flex"> 
          ...
          <Link className="btn bg-white test-success mx-1" to="/login">Login</Link>
            ...
            <Link className="btn bg-white test-success mx-1" to="/createuser">SignUp</Link>
          </li>
        </div>
        :<div>
        <div className="btn bg-white text-success mx-2" onClick={changeViewCart}>
